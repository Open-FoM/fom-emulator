...
|---|---|---|---|---|---|
| 0x04 | ID_CONNECTION_REQUEST | client -> server | RakNet (fom_client) | ID_CONNECTION_REQUEST.md | RakNet 3.5 offline handshake |
...
| 0x10 | ID_NEW_INCOMING_CONNECTION | server -> client | RakNet (fom_client) | ID_NEW_INCOMING_CONNECTION.md | RakNet 3.5 online handshake |
