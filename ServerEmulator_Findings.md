...
Purpose: preserve findings for FoTD Ghidra work and protocol alignment.
...
## Suggested Next Checks (FoTD)
- Re-locate RTTI strings (.?AVClientNetworking@@, packet RTTI) in FoTD.
- Validate reliable header layout + msg# location via live packets or FoTD decomp.
